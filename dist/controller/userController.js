...
exports.singleAgent = exports.loginAgent = exports.createUserAgent = void 0;
...
exports.createUserAgent = (0, asyncHandler_1.asyncHandler)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
...
exports.singleAgent = (0, asyncHandler_1.asyncHandler)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
